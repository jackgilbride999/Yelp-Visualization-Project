...
void setup() {
  ...
  Scrollbar scrollbar = new Scrollbar(10, SCREEN_Y*2, color(150), SCROLLBAR_EVENT); // just adding a scrollbar incase we need it, by default it will not scroll and will just take up side of screen //<>//
